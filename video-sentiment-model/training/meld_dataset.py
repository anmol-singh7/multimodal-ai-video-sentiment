...
class MELDDataset(Dataset):
    ...
    def __init__(self,csv_path, video_dir):
        ...
        self.emotion_map = {
            'anger': 0, 'disgust': 1, 'sadness': 2, 'joy': 3, 'neutral': 4, 'surprise': 5, 'fear': 6
        }
...
def prepare_dataloaders(trains_csv, train_video_dir,
                        dev_csv, dev_video_dir,
                        test_csv, test_video_dir, batch_size=32):
    
    train_dataset = MELDDataset(trains_csv,train_video_dir)
